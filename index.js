...
import { findSecret, readSecretState } from "../../../secrets.js";

// Keep track of where your extension is located, name should match repo name
const extensionName = "tabby-loader";
...
async function onLoaderOpenClick() {
    if (!isTabby()) {
    ...
    console.log(await findSecret("admin_key_tabby"))

    const loaderHtml = $.get(`${extensionFolderPath}/loader.html`);
